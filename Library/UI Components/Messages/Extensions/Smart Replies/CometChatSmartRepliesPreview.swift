...
//  CometChatSmartRepliesPreview.swift
//  CometChatUIKit
...
@IBDesignable class CometChatSmartRepliesPreview: UIView {
    ...
    weak var smartRepliesDelegate: CometChatSmartRepliesPreviewDelegate?
   ...
   // MARK: - Private instance Methods
    ...
    private func setupCollectionView() {
        ...
        let CometChatSmartRepliesPreviewItem = UINib(nibName: "CometChatSmartRepliesPreviewItem", bundle: UIKitSettings.bundle)
        collectionView.register(CometChatSmartRepliesPreviewItem, forCellWithReuseIdentifier: "CometChatSmartRepliesPreviewItem")
    }
}
...
extension CometChatSmartRepliesPreview: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
         let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CometChatSmartRepliesPreviewItem", for: indexPath) as! CometChatSmartRepliesPreviewItem
        cell.smartrepliespreviewitemdelegate = self
...
extension CometChatSmartRepliesPreview: CometChatSmartRepliesPreviewItemDelegate {
