//  CometChatPrivacyAndSupportItem.swift
//  CometChatUIKit
...
class CometChatSharedMedia: UITableViewCell {
    ...
    /**
     This method setup the collectionView for  CometChatSharedMedia.
    ...
    private func setupCollectionView() {
        ...
        let CometChatSharedMediaItem = UINib(nibName: "CometChatSharedMediaItem", bundle: UIKitSettings.bundle)
        collectionView.register(CometChatSharedMediaItem, forCellWithReuseIdentifier: "CometChatSharedMediaItem")
    ...
    /**
     This method fetches the media messages for CometChatSharedMedia.
     - Parameters:
    ...
    /**
     This method fetches the previous media messages for CometChatSharedMedia.
     - Parameters:
     - entity: This specifies the entity for which messages are being fetched.
     - type: This specifies the type of entity for which messages are being fetched.
     - Author: CometChat Team
...
extension CometChatSharedMedia : UICollectionViewDelegate , UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CometChatSharedMediaItem", for: indexPath) as! CometChatSharedMediaItem
        switch self.mediaSelection.selectedSegmentIndex {
        case 0:
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let seletedMedia = collectionView.cellForItem(at: indexPath) as? CometChatSharedMediaItem {
            switch self.mediaSelection.selectedSegmentIndex {
