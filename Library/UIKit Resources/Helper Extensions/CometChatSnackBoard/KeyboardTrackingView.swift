...
/// on `CometChatSnackBoard.Config.keyboardTrackingView` or `CometChatSnackBoardSegue.keyboardTrackingView`
/// for automatic keyboard avoidance for the entire CometChatSnackBoard view or view controller.
